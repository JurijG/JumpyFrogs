...
#include "AnimNotifies/DestroyAnimNotify.h"
#include "Interfaces/FrogInterface.h"

void UDestroyAnimNotify::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	...
	if (AActor* Owner = MeshComp->GetOwner())
	{
		...
		{
			IFrogInterface::Execute_DestroyFrog(Owner);
		}
	}
}
